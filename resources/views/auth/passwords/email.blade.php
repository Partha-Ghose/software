                            ...
                            <div class="p30">
                                ...
                                <form method="POST" action="{{ route('user-password-email-reset-link') }}">
                                    ...
                                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        <input class="sign-up-input form-control" name="phone" placeholder="Phone No" type="text" id="phone" value="{{ old('phone') }}" required>
                                    ...
                                    <button type="submit"
                                     ...
                                     style="width: 100%">Submit & check your Phone</button>
                                </form>

...
<div class="footer-secondary  p30" style="background-color:#000;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-12 xs-mb30">
                <div class="social-icons ">
                    <ul>
                        <li title="Facebook" style=" background-color: rgb(255, 255, 255); padding: 2px 8px; border-radius: 50%; padding-top: 6px;"><a href="{{ $shop_info->facebook }}"><i class="lni-facebook-filled"></i></a></li>
                        <li title="Twitter" style=" background-color: rgb(255, 255, 255); padding: 2px 8px; border-radius: 50%; padding-top: 6px;"><a href="{{ $shop_info->twitter }}"><i class="lni-twitter-filled"></i></a></li>
                        <li title="Youtube" style=" background-color: rgb(255, 255, 255); padding: 2px 8px; border-radius: 50%; padding-top: 6px;"><a href="{{ $shop_info->youtube }}"><i class="lni-youtube"></i></a></li>
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12">
                    <div class="footer-copyright text-r xs-text-c">
                        <span  style="color:#fff !important;">{{ $shop_info->footer_text }}</span>
                    </div>
                </div>
            </div>
        </div>
